...
let to_jade_loc loc =
  let conv pos =
    {
      Jade.Loc.pos_begin_cnum = pos.pos_begin_cnum;
      pos_begin_lnum = pos.pos_begin_lnum;
      pos_begin_bol  = pos.pos_begin_bol;
      pos_end_cnum   = pos.pos_end_cnum;
      pos_end_lnum   = pos.pos_end_lnum;
      pos_end_bol    = pos.pos_end_bol;
    }
  in
  Option.map conv loc
